...
class NuScenes3DDetTrackDataset(Dataset):
    ...
    def show(self, results, tokens, save_dir=None, show=False, pipeline=None):
        ...
        for token, result in zip(tokens, results):
            ...
            data_info = pipeline(self.get_data_info(token))
            imgs = []
            ...
            cv2.imwrite(os.path.join(save_dir, f"{token}.jpg"), image)
