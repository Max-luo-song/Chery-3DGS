...
# source: offboard/mapping/converter/apollo/modules/map/proto/map_lane.proto
...
_LANEBOUNDARY.fields_by_name['curve'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__geometry__pb2._CURVE
_LANEBOUNDARY.fields_by_name['boundary_type'].message_type = _LANEBOUNDARYTYPE
_LANE.fields_by_name['id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['central_curve'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__geometry__pb2._CURVE
...
_LANE.fields_by_name['overlap_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['predecessor_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['successor_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['left_neighbor_forward_lane_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['right_neighbor_forward_lane_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['type'].enum_type = _LANE_LANETYPE
_LANE.fields_by_name['turn'].enum_type = _LANE_LANETURN
_LANE.fields_by_name['left_neighbor_reverse_lane_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['right_neighbor_reverse_lane_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
_LANE.fields_by_name['junction_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
...
_LANE.fields_by_name['self_reverse_lane_id'].message_type = offboard_dot_mapping_dot_converter_dot_apollo_dot_modules_dot_map_dot_proto_dot_map__id__pb2._ID
...
LaneBoundaryType = _reflection.GeneratedProtocolMessageType('LaneBoundaryType', (_message.Message,), {
  ...
  '__module__' : 'offboard.mapping.converter.apollo.modules.map.proto.map_lane_pb2'
