...
# source: onboard/can/apollo_can/proto/can_card_parameter.proto
...
CANCardParameter = _reflection.GeneratedProtocolMessageType('CANCardParameter', (_message.Message,), {
  ...
  '__module__' : 'onboard.can.apollo_can.proto.can_card_parameter_pb2'
