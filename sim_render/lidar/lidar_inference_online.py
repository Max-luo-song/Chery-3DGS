...
from sim_render.lidar.render import render_sets, get_logger, save_pcd_binary
...
class Renderer:
    ...
    def render_single_frame(self, pose, lidar_id=0):
        ...
        for block_id, train_frame_times in block_info.items():
            ...
            for key, pcd in render_outputs.items():
                ...
                render_output_filename = os.path.join(self.output_dir, f"ldr{lidar_id}_{timestamp}.pcd")
                save_pcd_binary(
