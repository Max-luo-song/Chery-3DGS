...
from phalp.configs.base import FullConfig, CACHE_DIR, PHALPConfig
...
class Human4DConfig(FullConfig):
    ...
    # 覆盖 phalp 字段，提供自定义的 PHALPConfig 实例，可以参考third_party/Humans4D/PHALP/phalp/configs/base.py
    phalp: PHALPConfig = field(default_factory=lambda: PHALPConfig(small_w=20, small_h=40))
    pass
...
def run_4DHumans(
    ...
    if not verbose:
        ...
        files_to_remove = [
            os.path.join(temp_dir, 'phalp_output', f'PHALP_{cam_id}.mp4') for cam_id in camera_list
        ]
