...
import math
from train import train_composite_report
from train import get_logger
from utils.metrics_utils import RaydropMeter, IntensityMeter, DepthMeter
...
def render_sets(gt_dynamic_model, dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool, insert_static_obj : bool, insert_dynamic_obj:bool, insert_objs = None, obj_type=None):
    ...
    with torch.no_grad():
        ...
        if not skip_test:
             ...
             dataset_name = "segment-1005081002024129653_5313_150_5333_150_with_camera_labels"
             ...
             train_composite_report(tb_writer, dataset, dataset_name, iteration, test_views, test_timestamp,\
                        model_id_scene_info, valid_timestamp_model, pipeline, background, logger)
